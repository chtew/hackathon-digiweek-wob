This is configured for running on server for domain pb.digiweek.de.
...
* 7. checkout project and go to `/hackathon/deployment/https`
...
* 10. execute `hackathon-docker-compose up -d` and `env-docker-compose up -d`
...
* go to https://pb.startwit.de/auth, login and create user for hackathon
